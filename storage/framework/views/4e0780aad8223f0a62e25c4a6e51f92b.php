        ...
        <div class="container-sm mt-5">
            ...
            <table class="table caption-top">
                ...
                <tbody>
                    <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-toggle="modal" data-target="#adminModal" data-id="<?php echo e($admin->id); ?>">
                            <td><?php echo e($admin->first_name . ' ' . $admin->last_name); ?></td>
                            <td><?php echo e($admin->email); ?></td>
                            <td>
                                <label class="switch">
                                    <input type="checkbox" class="toggle-switch" data-id="<?php echo e($admin->id); ?>"
                                        <?php echo e($admin->is_active == 1 ? 'checked' : ''); ?>>
                                    <span class="slider"></span>
                                </label>
                            </td>
                            <td>
                                <div class="btn-group" role="group" aria-label="Admin Actions">
                                    <a href="<?php echo e(route('admin.edit', $admin->id)); ?>" class="btn btn-info btn-sm">
                                        <i class="bi bi-pencil-fill"></i> Edit
                                    </a>

                                    <form action="<?php echo e(route('admin.delete', $admin->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this admin?');">
                                        <?php echo csrf_field(); ?>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                    <form action="<?php echo e(route('addAdmin')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\wamp64\www\laravel\hrms\resources\views/moderator/index.blade.php ENDPATH**/ ?>