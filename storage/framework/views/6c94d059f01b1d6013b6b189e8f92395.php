...
<body>
    <div class="container">
        ...
        <form action="<?php echo e(route('import.upgrade')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="buttons-grid">
                ...
                <a href="<?php echo e(route('generate.employees')); ?>" class="btn btn-warning">
                    <i class="fas fa-sync-alt"></i> Mettre à jour le fichier
                </a>

                <a href="<?php echo e(asset('storage/nom1.xlsx')); ?>" class="btn btn-info" download>
            ...
            <?php if(session('success')): ?>
                <div class="alert alert-success">
                    ...
                    <div>
                        ...
                        <a href="<?php echo e(asset('storage/app/public/nom1.xlsx')); ?>" class="file-link" target="_blank">
        ...
        <form action="<?php echo e(route('run.upgrade')); ?>" method="POST" class="mt-4">
            <?php echo csrf_field(); ?>
            <button type="submit" class="btn btn-success">
...
<?php /**PATH C:\wamp64\www\laravel\hrms\resources\views/import_exel.blade.php ENDPATH**/ ?>