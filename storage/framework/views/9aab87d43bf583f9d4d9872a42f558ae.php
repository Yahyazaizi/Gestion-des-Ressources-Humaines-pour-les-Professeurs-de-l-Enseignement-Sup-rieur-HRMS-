...
<section class="home-section" style="margin-bottom: 500px">
    ...
    <div class="position-absolute top-0 end-0 m-4 me-1 d-flex">
        <a href="<?php echo e(route('notifications.index')); ?>" class="notification-bell" id="notificationBell">
...
<!-- Bouton pour afficher les options -->
    ...
    <div class="position-absolute top-0 end-0 m-4 me-5  d-flex" id="fullscreenBtn">
        <a href="<?php echo e(route('promotions.recherche')); ?>" class="btn-search-futur" id="searchButton">
    ...
    <div class="mycontent">
            ...
            <div>
                <form action="<?php echo e(route('employee.index')); ?>" method="GET" class="d-flex float-start">
                    ...
                    <select name="position" class="form-select ms-2">
                        ...
                        <?php $__currentLoopData = \App\Models\Position::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($position->id); ?>"
                                <?php echo e(request('position') == $position->id ? 'selected' : ''); ?>>
                                <?php echo e($position->name); ?> <?php echo e($position->employees->count()); ?>
                    ...
                    <div class="ms-2 btn-group" role="group" class="mb-3"> <!-- Bootstrap margin bottom class -->
                        ...
                        <a href="<?php echo e(route('employee.index')); ?>" class="btn btn-light btn-outline-dark">
        ...
        <br>
        <br>
        <a href="<?php echo e(route('employee.create')); ?>" class="btn btn-success">
        ...
        <div id="tableContainer">
            ...
            <?php echo $__env->make('private.employee.components.table', ['data' => $data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<?php /**PATH C:\wamp64\www\laravel\hrms\resources\views/private/employee/index.blade.php ENDPATH**/ ?>